# Python Advanced Data Structure Wheaties (Structured)
...
2. Create a function that takes a list of integers as an input and returns a new
   list of all of the integers in the original list that have exactly two zeroes.
    ...
    - Hint: `.count()`
3. Create a function that takes an integer and a list of integers as inputs and
...
4. Create a function that takes an integer as an input and returns a boolean of
   whether that number is a prime or not.
    - For example: `12 -> False`
    - For example: `13 -> True`
5. Create a function that takes a **list of lists of integers** as an input and
   returns the largest integer across all of the sub-lists.
    - For example: `[[9, 1], [14, 11], [10]] -> 14`
6. Create a function that processes a list of student records. Each student
   record is a NamedTuple containing `name` (str), `major` (str),and `gpa`
...
7. Create a function that takes a list of integers as an input and returns the
...
8. Create a function that takes a list of integers as an input and returns the
   number of times duplicates appear in the list.
    - For example: `[1, 1, 5, 1, 5, 6] -> 3`
    - For example: `[1, 5, 6, 1] -> 1`
9. Create a function that aggregates weather data. Use a NamedTuple to represent
...
10. Create a function that takes a dictionary as an input and returns a
...
11. Create a function that takes a dictionary as an input and returns the
   **value** with the highest frequency in a dictionary.
    - For example: `{"a": 1, "b": 2, "c": 1} -> 1`
12. Create a function that takes an integer as an input and returns a list
...
13. Create a function that takes a string as an input and returns a list of all
...
19. Create a function that takes a list of integers and returns how many pairs of
...
21. Create a function that takes two dictionaries as inputs. It then returns
    a new dictionary containing all of the key/value pairs that are in **both**
    dictionaries.
    - For example: `{1: 5, 3: 7}, {3: 4, 1: 5, 9: 10} -> {1: 5}`
    - Hint: Create an empty dict and add to it using the accumulator pattern
22. Create a tool for analyzing traffic data. Use a NamedTuple for each data
