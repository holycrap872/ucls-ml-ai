...
# Each Student First Week Check

## VSCode

[ ] `vscode` installed
[ ] `vscode` can run python
[ ] `black` and `isort` working
[ ] `pytest` working
[ ] `mypy` working
...
[ ] `git` installed
[ ] `python` installed
[ ] `matplotlib` capable of making graph and showing on screen
